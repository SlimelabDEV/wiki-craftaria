...
description: "Découvrez comment créer un serveur Minecraft Java, choisir un hébergement, accepter l'EULA et configurer les accès avec le wiki de Craftaria."
---
...
Si vous souhaitez jouer directement sur un serveur Minecraft francophone déjà configuré, vous pouvez rejoindre **Craftaria**.
