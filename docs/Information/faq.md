---
sidebar_position: 2
description: "Retrouvez les réponses aux questions fréquentes sur Craftaria : limites, commandes, mondes, règles, performances et problèmes courants."
---
...
:::tip 💡
En cas de perte ou d'oubli de votre mot de passe, rendez-vous sur le Discord de Craftaria et ouvrez un ticket avec le motif *J'ai un problème avec mon mot de passe*. Décrivez ensuite votre problème en suivant les indications du formulaire afin que le staff puisse vous aider.
:::
...
## 🧱 Blocs claimables
:::tip 🔒
- **Limite par défaut** : 250k blocs, possibilité d'augmenter jusqu'à 1 million avec le grade **Titan**.
