...
- De la terre et une houe
- Un seau d'eau
- Des graines de blé
- Des blocs de construction
- Un ou plusieurs distributeurs
- De la redstone, un bouton ou un levier
- Des entonnoirs et un coffre pour la collecte
- De la lumière si la ferme est couverte
...
3. Installez une bordure afin que les objets ne sortent pas du champ.
4. Placez une rigole de collecte au point le plus bas, avec des entonnoirs reliés à un coffre.
5. Ajoutez les distributeurs d'eau en haut du champ, orientés vers les cultures.
6. Reliez les distributeurs à un bouton ou à un levier.
7. Plantez les graines et laissez le blé atteindre sa maturité.
...
Réduisez la largeur du module ou ajoutez plusieurs courants qui convergent vers la même rigole. Vérifiez aussi qu'aucun bloc ne coupe le trajet de l'eau.

### Certaines terres deviennent sèches

Rapprochez-les d'une source d'eau. Une terre trop éloignée finit par perdre son hydratation et peut redevenir de la terre.

### Le blé pousse lentement
