...
- Des rails, un entonnoir et un coffre
...
3. Placez un distributeur face au mouton.
4. Reliez la sortie de l'observateur au distributeur.
5. Remplissez le distributeur de cisailles.
6. Enfermez le mouton sans bloquer l'herbe.
7. Faites circuler un wagonnet à entonnoir sous le bloc.
8. Reliez la collecte à un coffre.
...
Le bloc reste probablement en terre. Ajoutez des blocs d'herbe voisins et suffisamment de lumière pour permettre sa propagation.

### Le distributeur ne tond pas le mouton

Vérifiez son orientation et la présence de cisailles encore utilisables. Le mouton doit se trouver juste devant sa face.

### La laine reste au sol
