...
- Des entonnoirs, un coffre et éventuellement un wagonnet à entonnoir
...
1. Préparez les terres labourées et hydratez-les.
2. Plantez les graines puis attendez que les tiges arrivent à maturité.
3. Laissez un emplacement libre à côté de chaque tige.
4. Orientez un piston vers l'emplacement du futur fruit.
5. Placez un observateur pour détecter la mise à jour de la tige ou du bloc surveillé.
6. Reliez l'impulsion au piston.
7. Ajoutez une collecte sous les emplacements de pousse.
...
Vérifiez qu'au moins un bloc adjacent est libre et compatible. Une tige entourée de blocs occupés ne peut rien produire.

### Les pistons s'activent sans récolter

L'observateur peut détecter une mauvaise mise à jour. Contrôlez son orientation et assurez-vous que le piston vise exactement l'emplacement du fruit.

### La ferme se bloque après une récolte
