...
- Un comparateur
- De la redstone
- Des fioles en verre ou des cisailles
- Un coffre et des entonnoirs
- Des blocs pour fermer l'installation
...
- Avec des **fioles en verre**, le distributeur récupère des fioles de miel.
- Avec des **cisailles**, il récupère des rayons de miel.
...
3. Orientez un distributeur vers la ruche.
4. Placez le comparateur pour lire son niveau de remplissage.
5. Reliez le signal au distributeur avec le circuit de redstone adapté.
6. Remplissez le distributeur de fioles ou de cisailles.
7. Installez une collecte pour récupérer les objets.
8. Fermez la zone sans bloquer le trajet des abeilles.
...
L'entrée de la ruche peut être obstruée, il peut faire nuit ou pleuvoir, ou aucune fleur n'est accessible.

### Le distributeur se déclenche sans récolter

Vérifiez qu'il fait face à la ruche et qu'il contient le bon outil. Les cisailles finissent par s'user et doivent être remplacées.

### Les fioles restent dans le distributeur
